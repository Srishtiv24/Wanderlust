      ...
      var cards = acts
        .map(function (a, ai) {
          return (
            ...
            a.icon +
            '</span><div class="itin-activity-text">' +
            a.label +
            (a.sub
...
async function loadStays(dest) {
  ...
  try {
    ...
    var res = await fetch(
      "/api/tb-listings?dest=" + encodeURIComponent(destClean)
    );
    ...
    grid.innerHTML = listings
      .map(function (l) {
        ...
        return (
          ...
          " ondragstart=\"stayDragStart(event,'" +
          title +
          "','" +
          location +
          "','" +
