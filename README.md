...
## About
Wanderlust is a full-stack travel discovery and planning application that allows users to explore travel listings, create their own listings, and receive intelligent recommendations using a hybrid search system combining MongoDB full-text search and vector-based semantic search (RAG-based approach) with a smart itinerary planner.
